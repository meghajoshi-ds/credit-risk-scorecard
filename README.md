...
│   ├── models/                     # serialised models + scorecard config, created by notebook 04*
│   └── model_results.csv
...
\* Not committed, since both are regenerated by the notebooks. Run notebooks 01
to 04 once before launching `app.py`.
